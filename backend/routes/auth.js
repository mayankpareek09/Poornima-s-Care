...
router.post('/register-admin', async (req, res) => {
  try {
    ...
    const ALLOWED = ['academic_admin','hostel_admin','campus_admin','laundry_admin','council_admin','club_captain','vice_captain','canteen_admin','mess_admin','store_admin','guard','faculty','library_admin','placement_admin','medical_admin'];
